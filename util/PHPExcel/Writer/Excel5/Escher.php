        ...
        switch (get_class($this->object)) {
            ...
            case 'PHPExcel_Shared_Escher_DggContainer':
                ...
                $dggData =
                    pack(
                        'VVVV',
                        $this->object->getSSetIDMax(), // maximum shape identifier increased by one
                ...
                foreach ($IDCLs as $dgId => $maxReducedSSetID) {
                    $dggData .= pack('VV', $dgId, $maxReducedSSetID + 1);
                }
            ...
            case 'PHPExcel_Shared_Escher_DgContainer':
                ...
                $innerData .= $header . pack('VV', $countShapes, $this->object->getLastSSetID());
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                ...
                $data .= $header . pack('VV', $this->object->getSSetID(), $this->object->getSpgr() ? 0x0005 : 0x0A00);
