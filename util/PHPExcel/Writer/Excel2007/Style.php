...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @param     int                                    $SetID            Number Format identifier
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeNumFmt(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Style_NumberFormat $pNumberFormat = null, $SetID = 0)
    {
        ...
        if ($formatCode !== null) {
            ...
            $objWriter->writeAttribute('numFmtId', ($SetID + 164));
